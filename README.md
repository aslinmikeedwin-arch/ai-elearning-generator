...
| --------------- | --------------------- | ---------------------------------------- |
| Python 3.x      | Run the scripts       | [https://python.org](https://python.org) |
| Ollama          | Local AI model        | [https://ollama.com](https://ollama.com) |
| Llama 3.2 Model | AI language model     | Run: `ollama pull llama3.2`              |
| Node.js         | PowerPoint generation | [https://nodejs.org](https://nodejs.org) |
